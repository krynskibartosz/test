...
import { PointFindManyArgs } from "../../point/base/PointFindManyArgs";
import { Point } from "../../point/base/Point";
...
export class UserControllerBase {
  ...
  async findPoints(
    ...
    const query = plainToClass(PointFindManyArgs, request.query);
  ...
  async connectPoints(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: PointWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      points: {
        connect: body,
